import { StyleSheet, Text, View, TextInput, TouchableOpacity, Image, StatusBar, ImageBackground, Pressable, Linking } from "react-native";
        ...
        <MainWrapper>
            ...
            <View style={styles.form_container}>
                ...
                <View style={styles.form}>
                    <Input label="Username" value={userName} setValue={setUserName} placeholder="Enter Name" keyboardType="default" />
                    <Input label="Password" value={password} setValue={setPassword} placeholder="Enter Password" keyboardType="numeric" />
                    <Input label="Email" value={userId} setValue={setUserId} placeholder="Enter Email" keyboardType="email-address" />
